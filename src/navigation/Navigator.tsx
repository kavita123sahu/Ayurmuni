...
import Dowload from "../HRMS/dowload";
...
import Download from "../HRMS/dowload";
...
const HomeStack = () => {
    return (
        <Stack.Navigator initialRouteName="TabStack" screenOptions={hideHeader} >
            ...
            <Stack.Screen name={'PaymentSuccess'} component={PaymentSuccessScreen} options={{ headerShown: false, animation: 'slide_from_right' }} />
