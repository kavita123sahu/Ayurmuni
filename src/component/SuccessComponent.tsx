        ...
        <View style={loadingStyles.container}>
            <View style={loadingStyles.content}>
                ...
                <Text style={loadingStyles.subtitle}>
                    Please wait the Order is processing
                </Text>
            </View>
        </View>
    );
    ...
    return (
        <View style={successStyles.container}>
            ...
            <View style={[successStyles.emptyWishlist, { marginBottom: '20%' }]}>
                ...
                {/* <Text style={successStyles.emptyWishlistText}>Your order is Placed</Text> */}
                ...
                <TouchableOpacity
                    ...
                    {/* <Text style={successStyles.browseButtonText}>Continue to Shop</Text> */}
                </TouchableOpacity>
    ...
    if (currentScreen === 'loading') {
        return (
            <PaymentLoadingScreen
                ...
                route={{ params: { ProcessText: ProcessText } }}
