...
export const postAddress = async (data: object) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let serverResponse = await fetch(BaseUrl.base_url + 'ecom/addresses/', fetchParameter);
...
export const getAddressByID = async (addressID: string) => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let serverResponse = await fetch(BaseUrl.base_url + `ecom/addresses/${addressID}`, fetchParameter);
            let response = await serverResponse.json();
            resolve(response);
        }
        catch (error) {
