...
const TimeSlotBooking: React.FC = (props: any) => {
    ...
    const handleBookconsult = async (slot_data: any) => {
        ...
        console.log('Handling Book Consultation with slot data:', slot_data);
        try {
            setIsBooking(true);
            ...
            console.log('Book Consultation Payload:', send_data);
...
const msg = responseData?.error || responseData?.message || JSON.stringify(responseData);
            Alert.alert(
                ...
                "Success 🎉",
                `congratulations! Your consultation is booked!\nDate: ${selectedDate}\nTime: ${selectedTimeSlot}`,
                [
                    {
                        text: "OK",
                        onPress: () => {
