...
const NewPatient: React.FC = () => {
  ...
  const steps: StepConfig[] = [
    { type: 'input', question: 'Patient Name', key: 'name' },
    { type: 'input', question: 'Age / Date of Birth', key: 'age' },
    {
      type: 'single',
      question: 'Gender',
      key: 'gender',
    ...
    { type: 'input', question: 'Occupation', key: 'occupation' },
    { type: 'input', question: 'Patient ID', key: 'patientId' },
    { type: 'input', question: 'Weight (kg)', key: 'weight' },
    { type: 'input', question: 'Height (cm)', key: 'height' },
    {
      type: 'single',
      question: 'Prakriti (Body Type)',
      key: 'prakriti',
      options: [
        'Vata',
        'Pitta',
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.doneContainer}>
          <Text style={styles.doneText}>Patient Saved Successfully</Text>
        </View>
      </SafeAreaView>
    );
  }
