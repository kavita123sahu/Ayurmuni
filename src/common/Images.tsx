...
export const QUESTION_IMAGES = {
    knowPrakriti: require('../assets/images/consultant.png'),
    prakriti: require('../assets/images/consultant.png'),
    bodyType: require('../assets/images/consultant.png'),
    scalpHair: require('../assets/images/consultant.png'),
    bodyHair: require('../assets/images/consultant.png'),
    skin: require('../assets/images/consultant.png'),
    appetite: require('../assets/images/consultant.png'),
    bowel: require('../assets/images/consultant.png'),
    sweating: require('../assets/images/consultant.png'),
    sleep: require('../assets/images/consultant.png'),
    learning: require('../assets/images/consultant.png'),
    temperament: require('../assets/images/consultant.png'),
    personality: require('../assets/images/consultant.png'),
};
